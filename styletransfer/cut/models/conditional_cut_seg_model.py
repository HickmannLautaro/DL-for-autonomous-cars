...
class ConditionalCUTSegModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.opt.lambda_edge > 0.0:
            self.netE = networks.define_Seg(in_channels=opt.input_nc, out_channel=1, ngf=8,
    ...
    def optimize_parameters(self):
        ...
        if self.opt.lambda_edge > 0:
            self.loss_E = self.opt.lambda_edge * self.compute_segmentation_loss()
    ...
    def set_input(self, input):
        ...
        self.seg_A = input['ASeg'].to(self.device)
    ...
    def do_segmentation(self, images):
    ...
    def compute_segmentation_loss(self):
